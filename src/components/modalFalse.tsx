...
const ModalFalsePage: React.FunctionComponent<{
  modalIFalsesOpen: boolean;
  closeModal: () => void;
}> = ({ modalIFalsesOpen, closeModal }) => {
  return (
    <Modal
      isOpen={modalIFalsesOpen}
        ...
        <div className="w-full">
          <div className="mx-auto flex flex-col items-center gap-[32px]">
            ...
            <p className="text-[#000] text-lg font-normal text-center">
              Bạn đã hết số lượt bình chọn vui lòng bình chọn vào ngày mai.
            </p>
